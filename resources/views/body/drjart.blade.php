    ...
    <body>
        <header class="header-area header-sticky">
            ...
            <div class="row pb-5 mb-4">
                @foreach ($drjart as  $drjart)
                  
              <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                <!-- Card-->
                <div class="card rounded shadow-sm border-0">
                    
                  <div class="card-body p-4"><img src="/productimage/{{ $drjart->image}}" width="300px" alt="" class="img-fluid d-block mx-auto mb-3">
                    <h5> <a href="#" class="text-dark">{{ $drjart->name}}</a></h5>
                    <p class="small text-muted font-italic">{{ $drjart->price}}</p>
                    ...
                    <form action="{{ route('cart.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" value="{{ $drjart->id }}" name="id">
                        <input type="hidden" value="{{ $drjart->name }}" name="name">
                        <input type="hidden" value="{{ $drjart->quantity}}" name="quantity">
                        <input type="hidden" value="{{ $drjart->price}}"  name="price">
                        <input type="hidden" value="{{ $drjart->image }}"  name="image">
