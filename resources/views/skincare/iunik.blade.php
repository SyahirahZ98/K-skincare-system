            ...
            <div class="row pb-5 mb-4">
              ...
              <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                ...
                <div class="card rounded shadow-sm border-0">
                  ...
                  <div class="card-body p-4"><img src="/productimage/{{$iunik->image}}" width="300px" alt="" class="img-fluid d-block mx-auto mb-3">
                    <h5> <a href="#" class="text-dark">{{$iunik->name}}</a></h5>
                    <p class="small text-muted font-italic">{{$iunik->price}}</p>
